...
The templates for a build's STATUS and hand-off live beside this skill at `templates/`; the run log at `references/runs.md`.
...
### Step 2 · Research
**What.** Inside the workspace first, always; outside by tier: none at 1, web at 2, deep at 3.
