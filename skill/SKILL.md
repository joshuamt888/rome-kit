...
- **Hand-off points are where a retire is possible, not required.** At every hand-off point the plan names and at every step-8 close line, the hand-off is written and echoed, then the context rule in § 3 decides, whichever form the install left there. The retire is your call, unprompted, on context, never on ceremony.
